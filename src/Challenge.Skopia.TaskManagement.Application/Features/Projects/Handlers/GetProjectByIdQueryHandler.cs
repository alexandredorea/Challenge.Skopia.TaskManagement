...
internal sealed class GetProjectByIdQueryHandler(ITaskManagementContext context) : IRequestHandler<GetProjectByIdQuery, ApiResponse<ProjectDto>>
{
    public async Task<ApiResponse<ProjectDto>> Handle(GetProjectByIdQuery query, CancellationToken cancellationToken)
    {
        try
        {
